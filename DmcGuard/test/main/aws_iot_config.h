/**
 * @file test\main\aws_iot_config.h
...
// 第一次使用时注意这里需要更换为自己的证书，避免和别人同时使用一个物品而冲突
// Get from console  
// =================================================
#define AWS_IOT_MQTT_HOST              "a2vo7hd1vjfead-ats.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              443 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "led" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "led" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "AmazonRootCA1.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "17f5-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "17f5-private.pem.key" ///< device private key file nameDevice private key filename
// =================================================
