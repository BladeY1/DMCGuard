package com.example.speakerhome;
...
import com.example.speakerhome.databinding.ActivityDeviceDetailBinding;
...
public class DeviceDetailActivity extends AppCompatActivity {
        ...
        Callback getStatusCallback = new Callback() {
            ...
            public void onFailure(final Call call, IOException e) {
                ...
                DeviceDetailActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(DeviceDetailActivity.this, com.example.speakerhome.R.string.net_error, Toast.LENGTH_SHORT).show();
                    }
                });
            }
            @Override
                ...
                DeviceDetailActivity.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (finalResponseCode == 200) {
                            ...
                            Toast.makeText(DeviceDetailActivity.this, com.example.speakerhome.R.string.Success, Toast.LENGTH_SHORT).show();
                        } else if (finalResponseCode == 400){
                            Log.d("res",ResponseText);
                            Toast.makeText(DeviceDetailActivity.this, com.example.speakerhome.R.string.Fail, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
        ...
        Callback getStatusCallback = new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (responseCodeLogin == 200) {
                    Log.d("responseCodeLogin",Data.Light_Color);
                    Log.d("responseCodeLogin", String.valueOf(Data.Light_Status));
                    Log.d("responseCodeLogin", String.valueOf(Data.Light_Brightness));
    ...
    public void onChannelSettingBtnClick(View view){
        Intent intent = new Intent(DeviceDetailActivity.this, TokenApplyActivity.class);
        startActivity(intent);
        updateLightTimer.cancel();
        finish();
    }
