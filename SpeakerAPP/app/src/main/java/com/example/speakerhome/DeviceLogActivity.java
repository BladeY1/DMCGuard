...
import com.example.speakerhome.databinding.ActivityDeviceLogBinding;
import com.example.speakerhome.utils.Data;
import com.example.speakerhome.utils.HttpsUtils;
import com.example.speakerhome.utils.Log;
import com.example.speakerhome.utils.LogAdapter;
...
public class DeviceLogActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(DeviceLogActivity.this, TokenApplyActivity.class);
