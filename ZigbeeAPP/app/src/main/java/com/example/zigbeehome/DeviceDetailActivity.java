...
import com.example.zigbeehome.databinding.ActivityDeviceDetailBinding;
...
public class DeviceDetailActivity extends AppCompatActivity {
        ...
        Callback getStatusCallback = new Callback() {
            ...
            public void onFailure(final Call call, IOException e) {
                ...
                DeviceDetailActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(DeviceDetailActivity.this, com.example.zigbeehome.R.string.net_error, Toast.LENGTH_SHORT).show();
                    }
                });
            }
            @Override
                ...
                DeviceDetailActivity.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (finalResponseCode == 200) {
                            ...
                            Toast.makeText(DeviceDetailActivity.this, com.example.zigbeehome.R.string.Success, Toast.LENGTH_SHORT).show();
                        } else if (finalResponseCode == 400){
                            Log.d("res",ResponseText);
                            Toast.makeText(DeviceDetailActivity.this, com.example.zigbeehome.R.string.Fail, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    public void updateData(){
        ...
        System.out.println("最后Current Time = " + current_time);
        // 新代码结束
        Call call = okHttpClient.newCall(request);
        call.enqueue(getStatusCallback);
    }
