            ...
            switch (responseText.trim()) {
                ...
                case "suc":
                    ...
                    */
                    ...
                    receiveData();
                    String R_brightness="2";
                    String Param_brightness="0";//0为开
                    sendDataAsync(R_brightness, Param_brightness, token);
                    receiveData();
                    break;
                case "lon":
                    // 处于打开状态
                ...
                case "lgn":
                    ...
                    String current_time1 = now1.format(formatter1);
                    System.out.println("Current Time = " + current_time1);
                    */
                ...
                case "20":
                    // 设置亮度为 0.2
                    Data.Light_Brightness = 0.2f;
                    break;
                case "40":
                    // 设置亮度为 0.4
                    Data.Light_Brightness = 0.4f;
                    break;
                case "60":
                    // 设置亮度为 0.6
                    Data.Light_Brightness = 0.6f;
                    break;
                case "80":
                    // 设置亮度为 0.8
                    Data.Light_Brightness = 0.8f;
                    break;
                case "100":
                    // 设置亮度为 1.0
                    Data.Light_Brightness = 1.0f;
                    break;
                default:
